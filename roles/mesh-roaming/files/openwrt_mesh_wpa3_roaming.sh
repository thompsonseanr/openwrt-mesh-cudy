...
uci set network.lan.ipaddr='192.168.1.2'  # Adjust per mesh node
uci set network.lan.netmask='255.255.255.0'
uci set network.lan.gateway='192.168.1.1'
uci set network.lan.dns='192.168.1.1'
uci commit network

# === Setup batman-adv interfaces ===
...
uci set wireless.mesh5.network='mesh0'
...
uci set wireless.mesh2.network='mesh0'
